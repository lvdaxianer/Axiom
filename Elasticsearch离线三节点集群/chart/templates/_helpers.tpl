...
{{/* 行说明：配置 app.kubernetes.io/name 字段，形成 _helpers.tpl 所需资源。 */ -}}
app.kubernetes.io/name: {{ include "uino-elasticsearch.name" . }}
{{/* 行说明：配置 app.kubernetes.io/instance 字段，形成 _helpers.tpl 所需资源。 */ -}}
app.kubernetes.io/instance: {{ .Release.Name }}
{{/* 行说明：配置 app.kubernetes.io/version 字段，形成 _helpers.tpl 所需资源。 */ -}}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{/* 行说明：配置 app.kubernetes.io/managed-by 字段，形成 _helpers.tpl 所需资源。 */ -}}
app.kubernetes.io/managed-by: {{ .Release.Service }}
{{/* 行说明：配置 helm.sh/chart 字段，形成 _helpers.tpl 所需资源。 */ -}}
